...
for folder in ['train','test','val']:
    ...
    folder_path = os.path.join(current_path,'data','images',folder) # ./Team Project2/data/images/ 폴더에 존재하는 train/test/val 각각의 path 접근
    file_list = os.listdir(os.path.join(current_path,'data','images',folder)) # ↑ 각 폴더 내 이미지 파일 리스트화
